...
HD_PWD='/home/user/projects/raytracer/raytracer.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_test_pattern.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source vga_test_pattern.tcl -notrace
