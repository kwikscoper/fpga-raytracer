...
HD_PWD='/home/user/projects/raytracer/raytracer.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_test_pattern.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vga_test_pattern.tcl
